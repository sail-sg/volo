...
#### You may be also interested in our MLP-like Vision Transformer: [Vision Permutator](https://github.com/Andrew-Qibin/VisionPermutator) and our [Token Labeling](https://github.com/zihangJiang/TokenLabeling) training objective for Vision Transformers.
